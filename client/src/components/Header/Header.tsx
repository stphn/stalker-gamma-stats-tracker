...
export function Header({ connected, gameState }: HeaderProps) {
    ...
    const gameColor   = gameState === 'playing' ? 'green' : gameState === 'menu' ? 'amber' : 'red'
        ...
        <header className={styles.header}>
            ...
            <div className={styles.statusGroup}>
                ...
                <div className={styles.statusItem}>
                    ...
                    <span className={`${styles.statusLabel} ${styles[serverColor]}`}>Server</span>
                </div>
                <div className={styles.statusItem}>
                    <span className={`${styles.dot} ${styles[gameColor]}`} />
                    <span className={`${styles.statusLabel} ${styles[gameColor]}`}>Game</span>
                </div>
            </div>
        </header>
    )
